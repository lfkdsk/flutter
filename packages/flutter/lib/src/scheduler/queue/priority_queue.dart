...
abstract class PriorityQueue2<E> {
  ...
  factory PriorityQueue2([int comparison(E e1, E e2)]) = HeapPriorityQueue2<E>;
...
class HeapPriorityQueue2<E> implements PriorityQueue2<E> {
  ...
  /// is the case, `E` must implement [Comparable], and this is checked at
  /// runtime for every comparison.
  HeapPriorityQueue2([int comparison(E e1, E e2)])
