...
class _FollowState extends State<Follow> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < 200; ++i) {
      widgets.add(wordsCard(articleList[0]));
      widgets.add(wordsCard(articleList[1]));
      widgets.add(wordsCard(articleList[2]));
      widgets.add(billboard());
      widgets.add(wordsCard(articleList[3]));
    }
