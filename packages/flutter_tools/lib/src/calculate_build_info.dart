...
class FlutterBuildInfo {
  ...
  yaml.YamlMap loadYaml(String projectDir, String fileName) {
    final File targetFile = globals.fs.file(globals.fs.path.join(projectDir, fileName));
  ...
  void extractBuildInfo() {
    ...
    String _flutterwVersion = readFileAsString(globals.fs.path.join(projectDir,'.flutterw','cache'), '.version');
    _flutterwVersion ??= readFileAsString(globals.fs.path.join(projectDir,'..','.flutterw','cache'), '.version');
